...
var d8 = new InfoSquare(262.5, 0, color2, 0, 0, 0, 0, 0)
var e8 = new InfoSquare(350, 0, color1, 0, 0, 0, 0, 0)
...
var d7 = new InfoSquare(262.5, 87.5, color1, 0, 0, 0, 0, 0)
var e7 = new InfoSquare(350, 87.5, color2, 0, 0, 0, 0, 0)
...
var a5 = new InfoSquare(0, 262.5, color2, 0, 0, 0, 0, 0)
var b5 = new InfoSquare(87.5, 262.5, color1, 0, 0, 0, 0, 0)
var c5 = new InfoSquare(175, 262.5, color2, 0, 0, 0, 0, 0)
var d5 = new InfoSquare(262.5, 262.5, color1, 0, 0, 0, 0, 0)
var e5 = new InfoSquare(350, 262.5, color2, 0, 0, 0, 0, 0)
var f5 = new InfoSquare(437.5, 262.5, color1, 0, 0, 0, 0, 0)
var g5 = new InfoSquare(525, 262.5, color2, 0, 0, 0, 0, 0)
var h5 = new InfoSquare(612.5, 262.5, color1, 0, 0, 0, 0, 0)

var a4 = new InfoSquare(0, 350, color1, 0, 0, 0, 0, 0)
var b4 = new InfoSquare(87.5, 350, color2, 0, 0, 0, 0, 0)
var c4 = new InfoSquare(175, 350, color1, 0, 0, 0, 0, 0)
var d4 = new InfoSquare(262.5, 350, color2, 0, 0, 0, 0, 0)
var e4 = new InfoSquare(350, 350, color1, 0, 0, 0, 0, 0)
var f4 = new InfoSquare(437.5, 350, color2, 0, 0, 0, 0, 0)
var g4 = new InfoSquare(525, 350, color1, 0, 0, 0, 0, 0)
var h4 = new InfoSquare(612.5, 350, color2, 0, 0, 0, 0, 0)
...
var d2 = new InfoSquare(262.5, 525, color2, 0, 0, 0, 0, 0)
var e2 = new InfoSquare(350, 525, color1, 0, 0, 0, 0, 0)
...
var d1 = new InfoSquare(262.5, 612.5, color1, 0, 0, 0, 0, 0)
var e1 = new InfoSquare(350, 612.5, color2, 0, 0, 0, 0, 0)
...
function allClick (xmouse, ymouse) {
  ...
  for (var i = 0; i < squareArrayLength; i++) {
      ...
      if ((xmouse > infoArray[i].locX && xmouse < infoArray[i].locX + 87.5 && ymouse > infoArray[i].locY && ymouse < infoArray[i].locY + 87.5) &&
      ...
      || (unitType === 'peon' && squareArray[i].peon === 1) || (team === squareArray[i].team )) && (team === squareArray[i].team || squareArray[i].team === 0))
        ...
        placeUnit(xmouse, ymouse, infoArray[i].locX, infoArray[i].locY)
...
function placeUnit (xmouse, ymouse, locX, locY) {
  if (xmouse > locX && xmouse < locX + 87.5 && ymouse > locY && ymouse < locY + 87.5) {
...
if (squareArray[i].unit === 'peon' || squareArray[i].unit === 'warrior' || squareArray[i].unit === 'footman') {
